...
class FormPermissionsTests(TestCase):
    def test_created_with_no_departments_by_default(self) -> None:
...
class AdministratorPermissionsSyncTests(TestCase):
    def test_creates_group_if_missing(self) -> None:
        ...
        self.assertEqual(
            _permission_codenames(group),
            set(AdministratorPermissions.PERMISSION_CODENAMES),
        )

    def test_corrects_drifted_permissions(self) -> None:
        group = AdministratorPermissions.sync_permissions()
...
class AdministratorPermissionsGetOrCreateGroupTests(TestCase):
    def test_creates_group_with_permissions_synced_on_first_call(self) -> None:
    ...
    def test_does_not_resync_permissions_on_an_existing_group(self) -> None:
        group = AdministratorPermissions.get_or_create_group()
        group.permissions.clear()
...
class AdministratorPermissionsNotInAdminTests(TestCase):
    def test_administrator_permissions_is_not_registered_in_admin(self) -> None:
